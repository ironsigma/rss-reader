...
class Route
{
     ...
     * @return Route
     */
    public function setMapMethod($method, $request_method='GET')
    {
     ...
     * @return string
     */
    public function getMapMethod($request_method='GET')
    {
        if ( !isset($this->method[$request_method]) ) {
            return null;
        }

        return $this->method[$request_method];
    }
     ...
     * @return boolean
     */
    public function matchMap( $path_to_match, $request_method='GET')
    {
        ...
        foreach( $this_path_elements as $i => $this_path_element )
        {
            ...
            if( TRUE === isset($this->dynamicElements[$this_path_element]) )
            {
                ...
                if( $this->dynamicElements[$this_path_element] === $this_path_element )
                {
                    ...
                    else if( ':method' === $this_path_element && NULL === $this->getMapMethod($request_method) )
                    {
